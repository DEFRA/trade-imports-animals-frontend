...
| accompanyingDocumentType           | `4fdce1f7` | —             | conditional | presentGate    | accompanyingDocumentType | self-loop        |
| accompanyingDocumentAttachmentType | `50ede208` | —             | conditional | presentGate    | accompanyingDocumentType |                  |
| accompanyingDocumentReference      | `51fef319` | —             | conditional | presentGate    | accompanyingDocumentType |                  |
| accompanyingDocumentDateOfIssue    | `5210042a` | —             | conditional | presentGate    | accompanyingDocumentType |                  |
...
graph LR
  ...
  commodityCode --> cph
  accompanyingDocumentType --> accompanyingDocumentType
  accompanyingDocumentType --> accompanyingDocumentAttachmentType
  accompanyingDocumentType --> accompanyingDocumentReference
  accompanyingDocumentType --> accompanyingDocumentDateOfIssue
