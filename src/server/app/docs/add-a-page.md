...
- [`features/import-reason/page.js`](../sets/live-animals/journeys/linear/features/import-reason/page.js)
- [`features/import-reason/controller.js`](../sets/live-animals/journeys/linear/features/import-reason/controller.js)
- [`features/import-reason/template.njk`](../sets/live-animals/journeys/linear/features/import-reason/template.njk)
- [`features/import-reason/evaluation.js`](../sets/live-animals/journeys/linear/features/import-reason/evaluation.js)
- [`features/import-reason/copy/copy.en.js`](../sets/live-animals/journeys/linear/features/import-reason/copy/copy.en.js)
- [`features/import-reason/copy/copy.cy.js`](../sets/live-animals/journeys/linear/features/import-reason/copy/copy.cy.js)
- [`features/import-reason/copy/copy.test.js`](../sets/live-animals/journeys/linear/features/import-reason/copy/copy.test.js)
- [`features/import-reason/controller.test.js`](../sets/live-animals/journeys/linear/features/import-reason/controller.test.js)
- [`features/import-reason/import-reason.e2e.spec.js`](../sets/live-animals/journeys/linear/features/import-reason/import-reason.e2e.spec.js)
- [`model/obligations/sections/import-reason.js`](../sets/live-animals/obligations/sections/import-reason.js)
...
Read [`features/index.js`](../sets/live-animals/journeys/linear/features/index.js),
[`flow/flow.js`](../sets/live-animals/journeys/linear/flow/flow.js) and
[`flow/task-rows.js`](../sets/live-animals/journeys/linear/flow/task-rows.js) before registering the page.
...
Import the page identity into [`flow/flow.js`](../sets/live-animals/journeys/linear/flow/flow.js). Put it in the
right `sections` entry. Its position controls `nextInSection()` and
strictly-earlier prerequisites.

Import it into [`flow/task-rows.js`](../sets/live-animals/journeys/linear/flow/task-rows.js). Put it in an
...
- update [`features/hub/copy/copy.test.js`](../sets/live-animals/journeys/linear/features/hub/copy/copy.test.js),
  [`features/hub/hub.e2e.spec.js`](../sets/live-animals/journeys/linear/features/hub/hub.e2e.spec.js) and
...
Add the page to [`flow/run.js`](../sets/live-animals/journeys/linear/flow/run.js) only when it belongs in the
