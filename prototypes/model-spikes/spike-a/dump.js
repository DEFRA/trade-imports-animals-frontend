...
/**
 * Headless "surface the model without its UI" proof (acceptance bar item 5).
 *
 *   node prototypes/model-spikes/spike-a/dump.js <fixture>
 *
 ...
 * next/prev and missingRequired-with-reasons — for all three shapes, plus the
