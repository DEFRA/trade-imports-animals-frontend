/**
 * The protected-ncd feature's flow-page identity — authored ONCE here as a
 * pure data LEAF that imports NOTHING. Both the controller (which spreads it
 * into `meta`) and `flow/flow.js` (which lists it in a section) import this
 * same object, so the `{ id, slug }` is a shared
 ...
 * reading `undefined`.
 */
export const protectedNcdYearsPage = {
  id: 'protected-ncd-years',
  slug: 'addons/protected-ncd/years'
}
