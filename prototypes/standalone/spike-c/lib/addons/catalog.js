...
/**
 * The add-on catalog: the data array of policy add-ons the driver can pick,
 * each with its own short sub-journey of steps, plus a value->addon lookup.
 *
 * The "select 1-to-N options, each opening its own subtasks" pattern. Per-add-on
 * answers live under quote.addonData[value]; the chosen set is
