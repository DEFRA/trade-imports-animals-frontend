...
import { countryOfOriginPage as page } from '../page.js'

export const meta = { ...page, collects: ['countryOfOrigin'] }

const view = `${TEMPLATES}/features/origin/country-of-origin/country-of-origin`
const copy = copyFor({ en, cy }).countryOfOrigin
...
const countryItems = () => {
  ...
  return [
    ...
    {
      label: copy.country.ukGroupLabel,
