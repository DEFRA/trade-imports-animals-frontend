<!--
CANONICAL: prototypes/journey-config-spikes/EUDPA-249-flow-layer/docs/pick-a-shape.md
...
Relative links here that point to sibling references stay valid; links to
code files (`../obligations/*.js`) are relative to the CANONICAL location.
-->
