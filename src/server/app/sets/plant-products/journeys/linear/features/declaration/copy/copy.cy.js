// MACHINE-DRAFT Welsh — requires translator and legal review before release.
export const copy = {
  title: 'Datganiad',
  intro: [
    "Drwy glicio ar y blwch ticio ar waelod y dudalen rydych yn datgan eich bod wedi darllen a deall, derbyn a chytuno i delerau ac amodau'r datganiad.",
    "Ni chaniateir cyflwyno'r ffurflen nes bod pob maes wedi'i gwblhau a'r blwch ticio wedi'i dicio."
  ],
  englandWales: {
    heading: 'Ar gyfer Cymru a Lloegr',
    apha: "Bydd yr Asiantaeth Iechyd Anifeiliaid a Phlanhigion (APHA) yn cynnal gweithdrefnau gwirio rheolaethau ar blanhigion, cynhyrchion planhigion a gwrthrychau eraill sy'n dod i mewn i Gymru a Lloegr.",
    defra:
      "Mae APHA yn asiantaeth weithredol i Adran yr Amgylchedd, Bwyd a Materion Gwledig (DEFRA), sy'n gweithredu polisi iechyd planhigion yng Nghymru a Lloegr o dan Femorandwm Cyd-ddealltwriaeth â Defra a Llywodraeth Cymru.",
    policyStatementLabel: 'Datganiad Polisi Gorfodi Mewnforion APHA',
    inspectorates:
      "Mae'r Arolygiaeth Iechyd Planhigion a Hadau (PHSI) a'r Arolygiaeth Marchnata Garddwriaethol (HMI) yn rhan o APHA ac yn dilyn",
    enforcementPolicyLinkText: 'polisi gorfodi DEFRA (PDF)'
  },
  scotland: {
  ...
  terms: {
    heading: 'Datganiad o delerau ac amodau ar gyfer ceisiadau',
    aphaDefinition:
      'At ddibenion y datganiad mae "APHA" yn cyfeirio at HMI a PHSI.',
    items: [
  ...
  enquiries: {
    heading: 'Ymholiadau mewnforio',
    aphaLabel: 'Cyswllt APHA:',
    aphaAddressLines: [
      'Enw: Animal and Plant Health Agency,',
      'Adeilad: Foss House',
      'Cyfeiriad: Kings Pool, 1-2 Peasholme Green,',
      'Dinas: York,',
      'Cod post: YO1 7PX',
      'Ffôn: 0300 1000 313',
      'E-bost: phsi-importers@apha.gov.uk'
    ],
    sasaLabel: 'Cyswllt SASA:',
    sasaEmail: 'E-bost: hort.marketing@gov.scot'
  },
  dataProtection: {
    heading: 'Datganiad Diogelu Data',
    body: "Defra yw'r rheolydd data ar gyfer data personol rydych yn ei roi i APHA/SASA neu'r hyn a gedwir amdanoch. Mae APHA/SASA yn ei ddefnyddio yn unol â'r Ddeddf Diogelu Data. Am ragor o wybodaeth ewch i",
    aphaPrivacyLinkText: 'hysbysiad preifatrwydd APHA (PDF)',
    linkSeparator: 'a',
    sasaPrivacyLinkText: 'datganiad preifatrwydd SASA'
  },
  legal: {
  ...
  declarationLabel:
    "Rwyf/Rydym wedi darllen a deall yr Amodau, y Datganiad Diogelu Data a'r Datganiadau Cyfreithiol",
  dateOfDeclaration: 'Dyddiad y datganiad:',
  submitButton: 'Cyflwyno hysbysiad',
  errors: {
    declarationRequired:
      "Rhaid ichi gadarnhau eich bod wedi darllen a deall yr Amodau, y Datganiad Diogelu Data a'r Datganiadau Cyfreithiol"
  }
}
