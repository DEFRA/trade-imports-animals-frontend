...
/**
 * String-field schema factories used by sections.js / addons.js
 * (requiredTextSchema, emailSchema, phoneSchema). Each declares a field's
 * canonical rules once so they compose with `Joi.object().concat(...)`.
 */
