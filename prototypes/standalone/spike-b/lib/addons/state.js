...
import { addonByValue, addonOptions } from './data.js'

/**
 * Add-on state helpers — read/write the chosen set and each add-on's per-step
 * answers, and derive completeness + the view models the selection page and the
 * task-list hub render.
 *
