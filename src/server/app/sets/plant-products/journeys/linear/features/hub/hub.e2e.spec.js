...
const TASK_STATUS_SELECTOR = '.govuk-task-list__status'
...
const initialStateTests = () => {
  test('renders the reference and unavailable Review and submit entry', async ({
    ...
    await expect(page.locator(TASK_STATUS_SELECTOR)).toHaveText([
