...
- **flow** ([`flow/flow.js`](../sets/live-animals/journeys/linear/flow/flow.js)) — sections, pages, dispatch and gates.
- **frontend** ([`features/index.js`](../sets/live-animals/journeys/linear/features/index.js),
...
[`features/index.js`](../sets/live-animals/journeys/linear/features/index.js). A
...
**journey shape**. They live in [`flow/flow.js`](../sets/live-animals/journeys/linear/flow/flow.js),
[`flow/task-rows.js`](../sets/live-animals/journeys/linear/flow/task-rows.js) and
...
- A **two-tier rule**: "derived unless authored" is more to learn than
  "every gate is written where you can see it", and [`flow.js`](../sets/live-animals/journeys/linear/flow/flow.js)
