...
- [`flow/flow.js`](../sets/live-animals/journeys/linear/flow/flow.js) — the ordered `sections` array (each an `id`
...
Each feature registered in [`features/index.js`](../sets/live-animals/journeys/linear/features/index.js) is a
...
several controller/template pairs. [`features/index.js`](../sets/live-animals/journeys/linear/features/index.js)
