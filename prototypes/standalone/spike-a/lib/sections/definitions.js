...
// once via the error-re-render path (raw `request.payload` strings). The
// presence check spans both shapes so we keep typed primitives when validated
// and preserve the user's typed strings when re-rendering after a failed submit.
