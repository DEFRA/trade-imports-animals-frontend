<!--
CANONICAL: prototypes/journey-config-spikes/EUDPA-249-flow-layer/docs/add-an-obligation.md
...
NOTE: The checklist below (steps 3 "presentation copy" and 4 "flow entry")
covers the journey layer — OUT OF SCOPE for the obligation skill. The
skill's own workflow trims to the obligation-side steps only; use this doc
only when you need the wider context (e.g. explaining what the user needs
to do outside the skill's scope).
-->
