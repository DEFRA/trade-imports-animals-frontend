...
Both run inside the unit suite (`npm run test:obligations-v2-spike` from the repo root). This page explains what they do, why they are trustworthy, and where the proof deliberately stops.
