<!--
CANONICAL: prototypes/journey-config-spikes/EUDPA-249-flow-layer/docs/worked-examples.md
...
NOTE: The Meta-pattern §12-step recipe below covers BOTH the obligation
layer and the journey layer (flow / features / routes / i18n / CYA). The
obligation skill's own workflow covers only the obligation-side steps; refer
to this recipe when a user wants the full end-to-end pattern.
-->
